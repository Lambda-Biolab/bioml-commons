...
| `bioml-private-retrieval` 🔒 | `Lambda-Biolab/bioml-private-retrieval` (private) | Legally-exposed retrieval modules — optional import for research agents | [ADR-006](decisions/adr-006-public-private-asset-policy.md) |
